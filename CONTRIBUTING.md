Contributing to Bulldog Core
============================

The Bulldog Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bulldog Core project, and is not to be
confused with overall Bulldog Network Protocol consensus changes.

Whether a pull request is merged into Bulldog Core rests with the project merge
...
Patches that change bulldog consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bulldog consensus, it must have been
...
The project leader is the release manager for each Bulldog Core release.

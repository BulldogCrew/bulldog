...
RESOURCES += src/qt/bulldog.qrc src/qt/bulldog_locale.qrc

TRANSLATIONS += src/qt/locale/bulldog_bg.ts \
                src/qt/locale/bulldog_de.ts \
                src/qt/locale/bulldog_en.ts \
                src/qt/locale/bulldog_es.ts \
                src/qt/locale/bulldog_fi.ts \
                src/qt/locale/bulldog_fr.ts \
                src/qt/locale/bulldog_it.ts \
                src/qt/locale/bulldog_ja.ts \
                src/qt/locale/bulldog_pl.ts \
                src/qt/locale/bulldog_pt.ts \
                src/qt/locale/bulldog_ru.ts \
                src/qt/locale/bulldog_sk.ts \
                src/qt/locale/bulldog_sv.ts \
                src/qt/locale/bulldog_vi.ts \
                src/qt/locale/bulldog_zh_CN.ts \
                src/qt/locale/bulldog_zh_TW.ts

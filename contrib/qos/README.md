...
This means one can have an always-on bulldogd instance running, and another local bulldogd/bulldog-qt instance which connects to this node and receives blocks from it.

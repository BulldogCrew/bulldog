...
In order to support loading of multiple wallets in bulldog-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bulldog.cpp.
...
Changes to bulldog.cpp
----------------------
bulldog.cpp is the entry point into bulldog-qt, and as such, will require some minor modifications to provide hooks for

...
This mechanism has been integrated into Bitcore-Node-bulldog which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bulldog-Project/insight-api-bulldog#web-socket-api](https://github.com/bulldog-Project/insight-api-bulldog#web-socket-api) 
* API: [https://github.com/bulldog-Project/insight-api-bulldog#swifttx-transactions](https://github.com/bulldog-Project/insight-api-bulldog#swifttx-transactions) 
...
By default, the Bulldog Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bulldog Core daemon:

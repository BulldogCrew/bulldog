...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bulldog Core bulldog-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bulldog-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bulldog transaction") + "\n" +
                               "  bulldog-tx [options] -create [commands]   " + _("Create hex-encoded bulldog transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bulldog transaction

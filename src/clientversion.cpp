 ...
 * for both bulldogd and bulldog-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Bulldog Core");
...
/**
 * Split the Sub Version string such as /Bulldog Core:x.y.z/

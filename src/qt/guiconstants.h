...
/* bulldog GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bulldog"
#define QAPP_ORG_DOMAIN "bull.io"
#define QAPP_APP_NAME_DEFAULT "bulldog-Qt"
#define QAPP_APP_NAME_TESTNET "bulldog-Qt-testnet"

...
/** Utility functions used by the bulldog Qt UI.
 */
namespace GUIUtil
{
...
// Render bulldog addresses in monospace font
...
// Parse "bulldog:" URI into recipient object, return true on successful parsing

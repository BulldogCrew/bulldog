                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzbullPathCustom = GetArg("-zbullbackuppath", "");
    ...
    if(!strzbullPathCustom.empty()) {
        ui->wallet_customzbullbackuppath->setText(QString::fromStdString(strzbullPathCustom));
        ui->wallet_customzbullbackuppath_label->setVisible(true);
        ui->wallet_customzbullbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzbullPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bulldog RPC console.") + "<br>" +

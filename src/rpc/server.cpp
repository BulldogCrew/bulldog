...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "bulldog server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bulldog features */
    //    {"bulldog", "masternode", &masternode, true, true, false},
        {"bulldog", "listmasternodes", &listmasternodes, true, true, false},
        {"bulldog", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bulldog", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bulldog", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bulldog", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bulldog", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bulldog", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bulldog", "masternodedebug", &masternodedebug, true, true, false},
        {"bulldog", "startmasternode", &startmasternode, true, true, false},
        {"bulldog", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bulldog", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bulldog", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bulldog", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bulldog", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bulldog", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bulldog", "preparebudget", &preparebudget, true, true, false},
        {"bulldog", "submitbudget", &submitbudget, true, true, false},
        {"bulldog", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bulldog", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bulldog", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bulldog", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bulldog", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bulldog", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bulldog", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bulldog", "checkbudgets", &checkbudgets, true, true, false},
        {"bulldog", "mnsync", &mnsync, true, true, false},
        {"bulldog", "spork", &spork, true, true, false},
        {"bulldog", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbullseed", &getzbullseed, false, false, true},
        {"zerocoin", "setzbullseed", &setzbullseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbull", &searchdzbull, false, false, true},
        {"zerocoin", "dzbullstate", &dzbullstate, false, false, true},
...
{
    return "> bulldog-cli " + methodname + " " + args + "\n";
}

...
/**
 * bulldog RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbullseed(const UniValue& params, bool fHelp);
extern UniValue getzbullseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbull(const UniValue& params, bool fHelp);
extern UniValue dzbullstate(const UniValue& params, bool fHelp);

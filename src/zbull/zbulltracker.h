...
#ifndef bulldog_zbullTRACKER_H
#define bulldog_zbullTRACKER_H
...
public:
    CzbullTracker(std::string strWalletFile);
    ~CzbullTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzbullWallet* zbullWallet = NULL);

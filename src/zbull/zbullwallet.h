...
#ifndef bulldog_zbullWALLET_H
#define bulldog_zbullWALLET_H
...
public:
    CzbullWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczbull(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozbull(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

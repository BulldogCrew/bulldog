#!/usr/bin/env python3
# Copyright (c) 2019 The Bulldog Core developers
...
from fake_stake.base_test import bulldog_FakeStakeTest

class zbullwrappedSerialsTest(bulldog_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zbulls..." % DENOM_TO_USE)
